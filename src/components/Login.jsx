...
export const Login = ({
  ...
  useEffect(() => {
    setRedirectURL(window.location.origin + `/${tenantID}/verify-oauth`);
    const {
      data: { subscription },
              ...
              <button
                ...
                onClick={() => {
                  supabase.auth.signInWithOAuth({
                    provider: "google",
                    options: {
                      // redirectTo: window.location.origin + "/verify-oauth",
                      // workaround for domain
                      redirectTo: redirectURL,
                      queryParams: {
                        access_type: "offline",
                        prompt: "consent",
                        // if we add this it will allow only users that have access to the email of that domain
                        // hd: tenantDomain,
                      },
                    },
                  });
